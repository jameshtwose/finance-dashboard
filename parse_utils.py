...
ING_DUTCH_TO_ENGLISH_dict = dict(zip(ING_DUTCH_columns_list, ING_ENGLISH_columns_list))
...
ASN_DUTCH_TO_ENGLISH_dict = dict(zip(ASN_column_subset, ASN_ENGLISH_columns_list))


# BUNQ
BUNQ_column_subset = ["Date", "Amount", "Account", "Counterparty", "Name"]

BUNQ_TO_ING_names_dict = dict(
    zip(
        BUNQ_column_subset,
        ["Date", "Amount (EUR)", "Account", "Counterparty", "Name / Description"],
    )
)
...
REVOLUT_TO_ING_names_dict = dict(
    zip(
        REVOLUT_column_subset,
        ["Date", "Amount (EUR)", "Account", "Name / Description", "Debit/credit"],
    )
)
...
REVOLUT_BUSINESS_TO_ING_names_dict = dict(
    zip(
        REVOLUT_BUSINESS_column_subset,
        ["Date", "Amount (EUR)", "Name / Description", "Debit/credit"],
    )
)
...
BANKINTER_TO_ING_names_dict = dict(
    zip(BANKINTER_column_subset, ["Date", "Name / Description", "Amount (EUR)"])
)
